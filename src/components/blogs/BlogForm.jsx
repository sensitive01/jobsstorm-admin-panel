...
import blogImageFallback from "../../../public/img-08.jpg";
import authorImageFallback from "../../../public/img-02.jpg";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.authorImage) {
        const authorImageResponse = await uploadCloudinary(
      ...
      if (response.data && response.data.success) {
        alert(
          blogId ? "Blog updated successfully!" : "Blog added successfully!",
        );
      ...
      console.error(
        blogId ? "Error updating blog:" : "Error adding blog:",
        error,
      );
      alert(
        blogId
                        ...
                        <>
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.target.src = blogImageFallback;
                            }}
                          />
                          <button
                            type="button"
                      ...
                      {authorImagePreview ? (
                        <>
                          <img
                            ...
                            onError={(e) => {
                              e.target.onerror = null;
                              e.target.src = authorImageFallback;
                            }}
                          />
                          <button
                            type="button"
